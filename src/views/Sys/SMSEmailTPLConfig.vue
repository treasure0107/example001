<template>
	<div class="panel">
        ...
        <el-input
          type="textarea"
          :rows="5"
          v-model="form.OffsiteLoginAlertTPL">
        </el-input>
        ...
        <el-input
          type="textarea"
          :rows="5"
          v-model="form.OffsiteLoginAlertTPL_EN">
        </el-input>
        ...
        <el-input
          type="textarea"
          :rows="5"
          v-model="form.DepositAlertTPL_EN">
        </el-input>
        ...
        <el-input
          type="textarea"
          :rows="5"
          v-model="form.WithdrawAlertTPL_EN">
        </el-input>
