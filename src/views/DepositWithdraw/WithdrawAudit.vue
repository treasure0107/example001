  ...
  <div class="panel">
    ...
    <section style="padding-bottom: 30px; margin-top: 16px;">
      ...
      <div style="padding: 20px;">
        <el-button v-if="isPath==2" type="success" @click="updateByIDs(1,'','审核通过')">审核通过</el-button>
        <el-button v-if="isPath==2" type="info" @click="updateByIDs(2,'','驳回提现')">驳回提现</el-button>
      </div>
      <div>
        <el-table
          ref="multipleTable"
          ...
          <el-table-column
            ...
            width="160">
            <template slot-scope="scope">
              <el-button type="primary" size="mini" @click="updateByIDs(1,scope.row.ID,'审核通过')" v-if="isPath==2">审核</el-button>
              <el-button type="success" size="mini" @click="updateByIDs(2,scope.row.ID,'驳回提现')" v-if="isPath==2">驳回</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
    ...
    methods: {
      ...
      updateHandle(Status, ID){
        ...
        try {
          let config = {
            method: "POST",
            url: baseUrl + "DepositWithdraw/AuditWithdraw",
            data: {
              RecordIds: RecordIds,
              Status: Status
            }
